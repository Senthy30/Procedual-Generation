...
public class MapGenerator : MonoBehaviour {
    ...
    public void DrawMapInEditor() {
        ...
        if (drawMode == DrawMode.NoiseMap) {
            ...
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve, levelOfDetail), TextureGenerator.TextureFromColourMap(mapData.colourMap, mapChunckSize, mapChunckSize));
        }
    }
